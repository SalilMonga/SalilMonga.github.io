...
export default function Navbar({ darkMode, toggleDarkMode }: { darkMode: boolean, toggleDarkMode: () => void }) {
  ...
  return (
    <header
      ...
      style={{ background: navBg, color: navText, borderBottom: `1px solid ${borderColor}` }}
    >
      <nav
      ...
      >
        ...
        <div className="flex items-center gap-4 ml-8">
          ...
          >
            {darkMode ? <><BsSun className="w-5 h-5" /> <span className="hidden sm:inline">Light Mode</span></> : <><BsFillMoonFill className="w-5 h-5" /><span className="hidden sm:inline">Dark Mode</span> </>}
          </button>
